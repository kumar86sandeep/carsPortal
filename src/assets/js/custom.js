 ...
 POTENZA.tabs = function () {
      ...
      $tabsnav.on('click', function () {
        console.log('hh');
          ...
          $("#tab1 > .accordion-title > a").first().addClass("active");
          $("#tab2 > .accordion-title > a").first().addClass("active");
          $("#tab3 > .accordion-title > a").first().addClass("active");

              
         
          $("#tab1 > .accordion-content").hide().first().slideDown("easeOutExpo");
          $("#tab2 > .accordion-content").hide().first().slideDown("easeOutExpo");
          $("#tab3 > .accordion-content").hide().first().slideDown("easeOutExpo");
