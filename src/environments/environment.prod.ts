export const environment = {
  ...
  // WEB_ENDPOINT: 'http://52.41.55.224',
  WEB_ENDPOINT: 'https://beta.carsgoat.com',
  ADDRESS_API:{
    ENDPOINT:'https://us-zipcode.api.smartystreets.com',
    // KEY: '35014350252469161',
    // TOKEN: 'Wh1Nl7Rt7BKpXxOwTPp4',
     KEY: '31535120318321986',
    TOKEN: 'sz37DilKCuIAwGpYhuix',
  },
  VEHICLE_STATS_API:{
    ENDPOINT:'https://www.carqueryapi.com/api/0.3',    
  },
 
  FILE_UPLOAD_API:"https://api.carsgoat.com/api/common/imageUploadtoBucket",
  APP_NAME: 'CarsGoat',
  ...
  SOCIAL_LOGINS: {
    GOOGLE: {
      GOOGLE_0AUTH_CLIENT_ID: '957425928645-agtp4pu3o419j212d6bev7qav5m5pj3e.apps.googleusercontent.com',
      GOOGLE_0AUTH_CLIENT_SECRET:'bvKkLnckjrqrBYzRcwemHF5Q'
    },
    FACEBOOK: {
      FACEBOOK_APP_ID: '805066839907874',
    },
    MICROSOFT: {
