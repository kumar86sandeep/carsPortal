...
export class PaymentMethodsComponent implements OnInit {
  ...
  readonly breadcrumbs: any[] = [{ page: 'Home', link: '/seller/home' }, { page: 'Saved Card Listing', link: '' }];
  ...
  */
  getPaymentMethods(postData) {  
    ...
    this.commonUtilsService.paymentMethodListings(postData).pipe(untilDestroyed(this)).subscribe(
      //case success
      (responseData) => {
  ...
  async removeCard(card_id){
    if(await this.commonUtilsService.isCardRemoveConfirmed()) {
      ...
      this.commonUtilsService.showPageLoader();
      this.commonUtilsService.removeCard(removeData).pipe(untilDestroyed(this)).subscribe(
        //case success
        (responseData) => {
          //console.log('pagedData', responseData)
  ...
  async defaultCard(card_id){
    if(await this.commonUtilsService.isDefaultCardConfirmed()) {
      ...
      this.commonUtilsService.showPageLoader();
      this.commonUtilsService.defaultCard(defaultCardData).pipe(untilDestroyed(this)).subscribe(
        //case success
        (responseData) => {
          //console.log('pagedData', responseData)
